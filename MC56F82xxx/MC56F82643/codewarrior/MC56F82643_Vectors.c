/******************************************************************************************
    MC56F82643 startup code, default ISR and vector table for use with DSC compiler
...
#pragma constarray off
...
#if (defined(SIM_MISC0_FAST_MODE_MASK) && defined(SIM_MISC0_MODE_STAT_MASK))
    if (0U == (SIM->RSTAT & SIM_RSTAT_SWR_MASK))
    {
        ...
        to set proper mode before software reset */
...
#endif /* (defined(SIM_MISC0_FAST_MODE_MASK) && defined(SIM_MISC0_MODE_STAT_MASK)) */
    ...
    OCCS->OSCTL2 &= ~(OCCS_OSCTL2_FREQ_TRIM200K_MASK | OCCS_OSCTL2_TEMP_TRIM8M_MASK);
    OCCS->OSCTL2 |=
        (SIM->NVMOPT2H & SIM_NVMOPT2H_ROSC_8M_TTRIM_MASK) | (SIM->NVMOPT2L & SIM_NVMOPT2L_ROSC_200K_FTRIM_MASK);
...
volatile asm void _vect(void) {
    ...
    JSR >Cpu_Interrupt            /* Interrupt no. 32*/
    ...
    JSR >Cpu_Interrupt            /* Interrupt no. 62*/
