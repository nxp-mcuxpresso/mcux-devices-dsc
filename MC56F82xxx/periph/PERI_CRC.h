...
typedef struct {
  __IO uint16_t CRCH;                              /**< CRC High Register, offset: 0x0 */
  __IO uint16_t CRCL;                              /**< CRC Low Register, offset: 0x1 */
  __IO uint16_t TRANSPOSE;                         /**< CRC Transpose Register, offset: 0x2 */
} CRC_Type;
...
/*! @name TRANSPOSE - CRC Transpose Register */
/*! @{ */

#define CRC_TRANSPOSE_TRANSPOSE_MASK             (0xFFU)
#define CRC_TRANSPOSE_TRANSPOSE_SHIFT            (0U)
