...
typedef struct {
  ...
  __IO uint16_t S;                                 /**< I2C Status register (corresponding to S1 in Reference Manual), offset: 0x3 */
...
/*! @name S - I2C Status register (corresponding to S1 in Reference Manual) */
/*! @{ */
 ...
 *  0b0001-0b1111..Filter glitches up to width of n bus clock cycles, where n=1-15d
 */
