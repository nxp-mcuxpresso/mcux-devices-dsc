...
typedef struct {
  ...
  __IO uint16_t SCHLTEN2;                          /**< ADC Scan Halted Interrupt Enable Register 2, offset: 0x71 */
} ADC_Type;
...
/*! @name SCHLTEN2 - ADC Scan Halted Interrupt Enable Register 2 */
/*! @{ */

#define ADC_SCHLTEN2_SCHLTEN_MASK                (0xFU)
#define ADC_SCHLTEN2_SCHLTEN_SHIFT               (0U)
/*! SCHLTEN
 *  0b0000..Scan halted interrupt is not enabled for this sample.
 *  0b0001..Scan halted interrupt is enabled for this sample.
 */
