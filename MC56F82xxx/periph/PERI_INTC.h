...
typedef enum _vector_type
{
    ...
    kReserved59_VECTORn             = 59,          /**< Vector no.59 */
    kQSPI0_RCV_VECTORn              = 60,          /**< Vector no.60 */
    kReserved60_VECTORn             = 60,          /**< Vector no.60 */
    kReserved61_VECTORn             = 61,          /**< Vector no.61 */
    kI2C0_VECTORn                   = 62,          /**< Vector no.62 */
    kReserved62_VECTORn             = 62,          /**< Vector no.62 */
    ...
    kReserved91_VECTORn             = 91,          /**< Vector no.91 */
...
typedef struct {
  ...
  __IO uint16_t IPR6;                              /**< Interrupt Priority Register 6, offset: 0x6, not available in all instances (available on 18 out of 21) */
