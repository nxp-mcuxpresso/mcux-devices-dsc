...
#define PWM_SM_DISMAP_COUNT                       2u
#define PWM_SM_COUNT                              4u
#define PWM_FAULT_COUNT                           2u
...
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x30 */
    ...
    __IO uint16_t FRACVAL1;                          /**< Fractional Value Register 1, array offset: 0x6, array step: 0x30, not available in all instances (available on 13 out of 24) */
    __IO uint16_t VAL1;                              /**< Value Register 1, array offset: 0x7, array step: 0x30 */
    __IO uint16_t FRACVAL2;                          /**< Fractional Value Register 2, array offset: 0x8, array step: 0x30, not available in all instances (available on 13 out of 24) */
    __IO uint16_t VAL2;                              /**< Value Register 2, array offset: 0x9, array step: 0x30 */
    __IO uint16_t FRACVAL3;                          /**< Fractional Value Register 3, array offset: 0xA, array step: 0x30, not available in all instances (available on 13 out of 24) */
    __IO uint16_t VAL3;                              /**< Value Register 3, array offset: 0xB, array step: 0x30 */
    __IO uint16_t FRACVAL4;                          /**< Fractional Value Register 4, array offset: 0xC, array step: 0x30, not available in all instances (available on 13 out of 24) */
    __IO uint16_t VAL4;                              /**< Value Register 4, array offset: 0xD, array step: 0x30 */
    __IO uint16_t FRACVAL5;                          /**< Fractional Value Register 5, array offset: 0xE, array step: 0x30, not available in all instances (available on 13 out of 24) */
    __IO uint16_t VAL5;                              /**< Value Register 5, array offset: 0xF, array step: 0x30 */
    __IO uint16_t FRCTRL;                            /**< Fractional Control Register, array offset: 0x10, array step: 0x30, not available in all instances (available on 13 out of 24) */
    ...
    __IO uint16_t DISMAP[PWM_SM_DISMAP_COUNT];       /**< Fault Disable Mapping Register 0..Fault Disable Mapping Register 1, array offset: 0x16, array step: index*0x30, index2*0x1 */
  ...
  __IO uint16_t DTSRCSEL;                          /**< Deadtime Source Select Register, offset: 0xC3 */
  __IO uint16_t MCTRL;                             /**< Master Control Register, offset: 0xC4 */
  __IO uint16_t MCTRL2;                            /**< Master Control 2 Register, offset: 0xC5, not available in all instances (available on 13 out of 24) */
  struct {                                         /* offset: 0xC6, array step: 0x4 */
    __IO uint16_t FCTRL;                             /**< Fault Control Register, array offset: 0xC6, array step: 0x4 */
    __IO uint16_t FSTS;                              /**< Fault Status Register, array offset: 0xC7, array step: 0x4 */
    __IO uint16_t FFILT;                             /**< Fault Filter Register, array offset: 0xC8, array step: 0x4 */
    __IO uint16_t FTST;                              /**< Fault Test Register, array offset: 0xC9, array step: 0x4 */
  } FAULT[PWM_FAULT_COUNT];
} PWM_Type;
...
/*! FRAC23_EN - Fractional Cycle Placement Enable fpr PWM_A
...
/*! FRAC45_EN - Fractional Cycle Placement Enable fpr PWM_B
...
/*! @name DTSRCSEL - Deadtime Source Select Register */
/*! @{ */
