...
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x10 */
    ...
    __IO uint16_t ENBL;                              /**< Timer Channel Enable Register, array offset: 0xF, array step: 0x10, valid indices: [0] */
...
/*! CM - Count Mode
 *  0b000..No operation
 *  0b001..Count rising edges of primary source Rising edges are counted only when SCTRL[IPS] = 0. Falling edges
 ...
 *  0b101..Count rising edges of primary source; secondary source specifies direction (1 = minus) Rising edges are
 *         counted only when SCTRL[IPS] = 0. Falling edges are counted when SCTRL[IPS] = 1.
