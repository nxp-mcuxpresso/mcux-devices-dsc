...
#if !defined(INTC_H_)
#define INTC_H_                                  /**< Symbol preventing repeated inclusion */
...
typedef enum _vector_type
{
    ...
    kReserved32_VECTORn             = 32,          /**< Vector no.32 */
    kCOCO_VECTORn                   = 32,          /**< Vector no.32 */
    ...
    kQSCI2_TIDLE_VECTORn            = 45,          /**< Vector no.45 */
    ...
    keFlexPWMB_FAULT_VECTORn        = 63,          /**< Vector no.63 */
    kReserved64_VECTORn             = 64,          /**< Vector no.64 */
    keFlexPWMB_RERR_VECTORn         = 64,          /**< Vector no.64 */
    kReserved65_VECTORn             = 65,          /**< Vector no.65 */
    keFlexPWMB_RELOAD3_VECTORn      = 65,          /**< Vector no.65 */
    kReserved66_VECTORn             = 66,          /**< Vector no.66 */
    keFlexPWMB_CAP3_VECTORn         = 66,          /**< Vector no.66 */
    kReserved67_VECTORn             = 67,          /**< Vector no.67 */
    keFlexPWMB_CMP3_VECTORn         = 67,          /**< Vector no.67 */
    kReserved68_VECTORn             = 68,          /**< Vector no.68 */
    keFlexPWMB_RELOAD2_VECTORn      = 68,          /**< Vector no.68 */
    kReserved69_VECTORn             = 69,          /**< Vector no.69 */
    keFlexPWMB_CAP2_VECTORn         = 69,          /**< Vector no.69 */
    kReserved70_VECTORn             = 70,          /**< Vector no.70 */
    keFlexPWMB_CMP2_VECTORn         = 70,          /**< Vector no.70 */
    kReserved71_VECTORn             = 71,          /**< Vector no.71 */
    keFlexPWMB_RELOAD1_VECTORn      = 71,          /**< Vector no.71 */
    kReserved72_VECTORn             = 72,          /**< Vector no.72 */
    keFlexPWMB_CAP1_VECTORn         = 72,          /**< Vector no.72 */
    kReserved73_VECTORn             = 73,          /**< Vector no.73 */
    keFlexPWMB_CMP1_VECTORn         = 73,          /**< Vector no.73 */
    kReserved74_VECTORn             = 74,          /**< Vector no.74 */
    keFlexPWMB_RELOAD0_VECTORn      = 74,          /**< Vector no.74 */
    kReserved75_VECTORn             = 75,          /**< Vector no.75 */
    keFlexPWMB_CAP0_VECTORn         = 75,          /**< Vector no.75 */
    ...
    keFlexPWMA_RELOAD3_VECTORn      = 79,          /**< Vector no.79 */
    keFlexPWMA_CAP_VECTORn          = 80,          /**< Vector no.80 */
    ...
    kFTFL_RDCOL_VECTORn             = 88,          /**< Vector no.88 */
    kFTFL_CC_VECTORn                = 89,          /**< Vector no.89 */
    ...
    kPDB1_VECTORn                   = 96,          /**< Vector no.96 */
    kPDB0_VECTORn                   = 97,          /**< Vector no.97 */
    kQDC_INDEX_RO_RU_VECTORn        = 98,          /**< Vector no.98 */
    kQDC_HOME_DOG_VECTORn           = 99,          /**< Vector no.99 */
    kQDC_COMPARE_VECTORn            = 100,         /**< Vector no.100 */
...
typedef struct {
  ...
  __IO uint16_t IPR7;                              /**< Interrupt Priority Register 7, offset: 0x7, not available in all instances (available on 8 out of 17) */
...
#define INTC_IPR2_ADC_COCO_SHIFT                 (14U)
/*! ADC_COCO - ADC_SAR Conversion Complete Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR2_ADC_COCO(x)                    (((uint16_t)(((uint16_t)(x)) << INTC_IPR2_ADC_COCO_SHIFT)) & INTC_IPR2_ADC_COCO_MASK)
/*! @} */
...
#define INTC_IPR4_QSCI2_TIDLE_MASK               (0x300U)
#define INTC_IPR4_QSCI2_TIDLE_SHIFT              (8U)
/*! QSCI2_TIDLE - QSCI 2 Transmitter Idle Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR4_QSCI2_TIDLE(x)                 (((uint16_t)(((uint16_t)(x)) << INTC_IPR4_QSCI2_TIDLE_SHIFT)) & INTC_IPR4_QSCI2_TIDLE_MASK)
...
#define INTC_IPR5_QSPI2_XMIT_SHIFT               (12U)
/*! QSPI2_XMIT - QSPI2 Transmitter Empty Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR5_QSPI2_XMIT(x)                  (((uint16_t)(((uint16_t)(x)) << INTC_IPR5_QSPI2_XMIT_SHIFT)) & INTC_IPR5_QSPI2_XMIT_MASK)

#define INTC_IPR5_QSPI2_RCV_MASK                 (0xC000U)
#define INTC_IPR5_QSPI2_RCV_SHIFT                (14U)
/*! QSPI2_RCV - QSPI2 Receiver Full Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR5_QSPI2_RCV(x)                   (((uint16_t)(((uint16_t)(x)) << INTC_IPR5_QSPI2_RCV_SHIFT)) & INTC_IPR5_QSPI2_RCV_MASK)
/*! @} */
...
#define INTC_IPR6_PWMB_FAULT_SHIFT               (12U)
 ...
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR6_PWMB_FAULT(x)                  (((uint16_t)(((uint16_t)(x)) << INTC_IPR6_PWMB_FAULT_SHIFT)) & INTC_IPR6_PWMB_FAULT_MASK)

#define INTC_IPR6_PWMB_RERR_MASK                 (0xC000U)
#define INTC_IPR6_PWMB_RERR_SHIFT                (14U)
 ...
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR6_PWMB_RERR(x)                   (((uint16_t)(((uint16_t)(x)) << INTC_IPR6_PWMB_RERR_SHIFT)) & INTC_IPR6_PWMB_RERR_MASK)
/*! @} */

/*! @name IPR7 - Interrupt Priority Register 7 */
/*! @{ */

#define INTC_IPR7_PWMB_RELOAD3_MASK              (0x3U)
#define INTC_IPR7_PWMB_RELOAD3_SHIFT             (0U)
...
#define INTC_IPR7_PWMB_CAP3_MASK                 (0xCU)
#define INTC_IPR7_PWMB_CAP3_SHIFT                (2U)
/*! PWMB_CAP3 - PWMB Submodule 3 Capture Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR7_PWMB_CAP3(x)                   (((uint16_t)(((uint16_t)(x)) << INTC_IPR7_PWMB_CAP3_SHIFT)) & INTC_IPR7_PWMB_CAP3_MASK)

#define INTC_IPR7_PWMB_CMP3_MASK                 (0x30U)
#define INTC_IPR7_PWMB_CMP3_SHIFT                (4U)
...
#define INTC_IPR7_PWMB_RELOAD2_SHIFT             (6U)
...
#define INTC_IPR7_PWMB_CAP2_MASK                 (0x300U)
#define INTC_IPR7_PWMB_CAP2_SHIFT                (8U)
/*! PWMB_CAP2 - PWMB Submodule 2 Capture Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR7_PWMB_CAP2(x)                   (((uint16_t)(((uint16_t)(x)) << INTC_IPR7_PWMB_CAP2_SHIFT)) & INTC_IPR7_PWMB_CAP2_MASK)

#define INTC_IPR7_PWMB_CMP2_MASK                 (0xC00U)
#define INTC_IPR7_PWMB_CMP2_SHIFT                (10U)
...
#define INTC_IPR7_PWMB_RELOAD1_SHIFT             (12U)
 ...
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR7_PWMB_RELOAD1(x)                (((uint16_t)(((uint16_t)(x)) << INTC_IPR7_PWMB_RELOAD1_SHIFT)) & INTC_IPR7_PWMB_RELOAD1_MASK)

#define INTC_IPR7_PWMB_CAP1_MASK                 (0xC000U)
#define INTC_IPR7_PWMB_CAP1_SHIFT                (14U)
/*! PWMB_CAP1 - PWMB Submodule 1 Capture Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR7_PWMB_CAP1(x)                   (((uint16_t)(((uint16_t)(x)) << INTC_IPR7_PWMB_CAP1_SHIFT)) & INTC_IPR7_PWMB_CAP1_MASK)
/*! @} */

/*! @name IPR8 - Interrupt Priority Register 8 */
/*! @{ */

#define INTC_IPR8_PWMB_CMP1_MASK                 (0x3U)
#define INTC_IPR8_PWMB_CMP1_SHIFT                (0U)
...
#define INTC_IPR8_PWMB_RELOAD0_MASK              (0xCU)
#define INTC_IPR8_PWMB_RELOAD0_SHIFT             (2U)
...
#define INTC_IPR8_PWMB_CAP0_SHIFT                (4U)
/*! PWMB_CAP0 - PWMB Submodule 0 Capture Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR8_PWMB_CAP0(x)                   (((uint16_t)(((uint16_t)(x)) << INTC_IPR8_PWMB_CAP0_SHIFT)) & INTC_IPR8_PWMB_CAP0_MASK)
...
#define INTC_IPR8_PWMA_RELOAD3_SHIFT             (12U)
...
#define INTC_IPR8_PWMA_CAP_SHIFT                 (14U)
...
#define INTC_IPR9_FTFL_RDCOL_SHIFT               (14U)
/*! FTFL_RDCOL - FTFL Access Error Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR9_FTFL_RDCOL(x)                  (((uint16_t)(((uint16_t)(x)) << INTC_IPR9_FTFL_RDCOL_SHIFT)) & INTC_IPR9_FTFL_RDCOL_MASK)
/*! @} */

/*! @name IPR10 - Interrupt Priority Register 10 */
/*! @{ */

#define INTC_IPR10_FTFL_CC_MASK                  (0x3U)
#define INTC_IPR10_FTFL_CC_SHIFT                 (0U)
/*! FTFL_CC - FTFL Command Complete Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR10_FTFL_CC(x)                    (((uint16_t)(((uint16_t)(x)) << INTC_IPR10_FTFL_CC_SHIFT)) & INTC_IPR10_FTFL_CC_MASK)
...
#define INTC_IPR10_PDB1_SHIFT                    (14U)
/*! PDB1 - PDB1 Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR10_PDB1(x)                       (((uint16_t)(((uint16_t)(x)) << INTC_IPR10_PDB1_SHIFT)) & INTC_IPR10_PDB1_MASK)
/*! @} */

/*! @name IPR11 - Interrupt Priority Register 11 */
/*! @{ */

#define INTC_IPR11_PDB0_MASK                     (0x3U)
#define INTC_IPR11_PDB0_SHIFT                    (0U)
/*! PDB0 - PDB0 Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR11_PDB0(x)                       (((uint16_t)(((uint16_t)(x)) << INTC_IPR11_PDB0_SHIFT)) & INTC_IPR11_PDB0_MASK)

#define INTC_IPR11_ENC_INDEX_MASK                (0xCU)
#define INTC_IPR11_ENC_INDEX_SHIFT               (2U)
/*! ENC_INDEX - Quad Decoder Index Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR11_ENC_INDEX(x)                  (((uint16_t)(((uint16_t)(x)) << INTC_IPR11_ENC_INDEX_SHIFT)) & INTC_IPR11_ENC_INDEX_MASK)

#define INTC_IPR11_ENC_HOME_DOG_MASK             (0x30U)
#define INTC_IPR11_ENC_HOME_DOG_SHIFT            (4U)
/*! ENC_HOME_DOG - Quad Decoder Home/Watchdog Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR11_ENC_HOME_DOG(x)               (((uint16_t)(((uint16_t)(x)) << INTC_IPR11_ENC_HOME_DOG_SHIFT)) & INTC_IPR11_ENC_HOME_DOG_MASK)

#define INTC_IPR11_ENC_COMPARE_MASK              (0xC0U)
#define INTC_IPR11_ENC_COMPARE_SHIFT             (6U)
/*! ENC_COMPARE - Quad Decoder Compare Interrupt Priority Level
 *  0b00..IRQ disabled (default)
 *  0b01..IRQ Priority Level 0
 *  0b10..IRQ Priority Level 1
 *  0b11..IRQ Priority Level 2
 */
#define INTC_IPR11_ENC_COMPARE(x)                (((uint16_t)(((uint16_t)(x)) << INTC_IPR11_ENC_COMPARE_SHIFT)) & INTC_IPR11_ENC_COMPARE_MASK)
