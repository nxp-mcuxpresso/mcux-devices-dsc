...
#if !defined(OCCS_H_)
#define OCCS_H_                                  /**< Symbol preventing repeated inclusion */
...
#define OCCS_OSCTL1_OSC_DIV2_MASK                (0x800U)
#define OCCS_OSCTL1_OSC_DIV2_SHIFT               (11U)
/*! OSC_DIV2 - Oscillator Divide By 2
 *  0b0..External oscillator output is not divided.
 *  0b1..External oscillator output is divided by 2 before use as MSTR_OSC.
 */
#define OCCS_OSCTL1_OSC_DIV2(x)                  (((uint16_t)(((uint16_t)(x)) << OCCS_OSCTL1_OSC_DIV2_SHIFT)) & OCCS_OSCTL1_OSC_DIV2_MASK)
...
#define OCCS_OSCTL2_FREQ_TRIM32K_MASK            (0x1FFU)
#define OCCS_OSCTL2_FREQ_TRIM32K_SHIFT           (0U)
/*! FREQ_TRIM32K - 32 kHz Internal RC Oscillator Frequency Trim */
#define OCCS_OSCTL2_FREQ_TRIM32K(x)              (((uint16_t)(((uint16_t)(x)) << OCCS_OSCTL2_FREQ_TRIM32K_SHIFT)) & OCCS_OSCTL2_FREQ_TRIM32K_MASK)
...
#define OCCS_OSCTL2_ROPD32K_SHIFT                (15U)
/*! ROPD32K - 32 kHz RC Oscillator Power Down */
#define OCCS_OSCTL2_ROPD32K(x)                   (((uint16_t)(((uint16_t)(x)) << OCCS_OSCTL2_ROPD32K_SHIFT)) & OCCS_OSCTL2_ROPD32K_MASK)
/*! @} */
