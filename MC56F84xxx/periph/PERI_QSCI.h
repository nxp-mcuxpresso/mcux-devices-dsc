...
#define QSCI_RATE_SBR_MASK                       (0xFFF8U)
#define QSCI_RATE_SBR_SHIFT                      (3U)
/*! SBR - SCI Baud Rate divider, a value from 1 to 8191 */
#define QSCI_RATE_SBR(x)                         (((uint16_t)(((uint16_t)(x)) << QSCI_RATE_SBR_SHIFT)) & QSCI_RATE_SBR_MASK)
/*! @} */
