...
!!GlobalInfo
product: Clocks v8.0
processor: MC56F84565
package_id: MC56F84565VLK
mcu_data: ksdk2_0
...
outputs:
- {id: BUS_2X_CLK.outFreq, value: 160 MHz}
- {id: BUS_CLK.outFreq, value: 80 MHz}
- {id: CPU_CLK.outFreq, value: 80 MHz}
- {id: MSTR_OSC.outFreq, value: 8 MHz}
- {id: ROSC32kHz_CLK.outFreq, value: 32 kHz}
- {id: ROSC8MHz_CLK.outFreq, value: 8 MHz}
- {id: SADC_ALT_CLK.outFreq, value: 4 MHz}
- {id: SCI0_CLK.outFreq, value: 80 MHz}
- {id: SCI1_CLK.outFreq, value: 80 MHz}
- {id: SCI2_CLK.outFreq, value: 80 MHz}
- {id: SYS_2X_CLK.outFreq, value: 160 MHz}
- {id: SYS_CLK.outFreq, value: 80 MHz}
- {id: SYS_FTFL.outFreq, value: 20 MHz}
settings:
- {id: OCCS.COD.scale, value: '1', locked: true}
- {id: OCCS.EXT_SEL.sel, value: N/A}
- {id: OCCS.PLLDB.scale, value: '40'}
...
clock_config_t occsConfig_BOARD_BootClockRUN =
    {
        ...
        .u32PllClkFreq = 320000000U,              /* PLL output frequency: 320000000Hz */
    };
