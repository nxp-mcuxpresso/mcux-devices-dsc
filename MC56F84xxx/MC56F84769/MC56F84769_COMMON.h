...
**
**     Abstract:
**         Peripheral Access Layer for MC56F84769
**
...
/*!
 * @file MC56F84769_COMMON.h
 * @version 2.0
 * @date 2021-02-06
 * @brief Peripheral Access Layer for MC56F84769
 *
 * Peripheral Access Layer for MC56F84769
 */

#if !defined(MC56F84769_COMMON_H_)
#define MC56F84769_COMMON_H_                     /**< Symbol preventing repeated inclusion */

#include "MC56F84769_features.h"
...
typedef enum IRQn {
  ...
  QSCI2_TIDLE_IRQn             = 36,               /**< QSCI2_TIDLE interrupt */
  ...
  QSPI2_XMIT_IRQn              = 46,               /**< QSPI2_XMIT interrupt */
  QSPI2_RCV_IRQn               = 47,               /**< QSPI2_RCV interrupt */
  ...
  eFlexPWMB_FAULT_IRQn         = 54,               /**< eFlexPWMB_FAULT interrupt */
  eFlexPWMB_RERR_IRQn          = 55,               /**< eFlexPWMB_RERR interrupt */
  eFlexPWMB_RELOAD3_IRQn       = 56,               /**< eFlexPWMB_RELOAD3 interrupt */
  eFlexPWMB_CAP3_IRQn          = 57,               /**< eFlexPWMB_CAP3 interrupt */
  eFlexPWMB_CMP3_IRQn          = 58,               /**< eFlexPWMB_CMP3 interrupt */
  eFlexPWMB_RELOAD2_IRQn       = 59,               /**< eFlexPWMB_RELOAD2 interrupt */
  eFlexPWMB_CAP2_IRQn          = 60,               /**< eFlexPWMB_CAP2 interrupt */
  eFlexPWMB_CMP2_IRQn          = 61,               /**< eFlexPWMB_CMP2 interrupt */
  eFlexPWMB_RELOAD1_IRQn       = 62,               /**< eFlexPWMB_RELOAD1 interrupt */
  eFlexPWMB_CAP1_IRQn          = 63,               /**< eFlexPWMB_CAP1 interrupt */
  eFlexPWMB_CMP1_IRQn          = 64,               /**< eFlexPWMB_CMP1 interrupt */
  eFlexPWMB_RELOAD0_IRQn       = 65,               /**< eFlexPWMB_RELOAD0 interrupt */
  eFlexPWMB_CAP0_IRQn          = 66,               /**< eFlexPWMB_CAP0 interrupt */
...
#define PWM_CAPTURE_IRQS                         { { NotAvail_IRQn, NotAvail_IRQn, NotAvail_IRQn, NotAvail_IRQn }, { eFlexPWMB_CAP0_IRQn, eFlexPWMB_CAP1_IRQn, eFlexPWMB_CAP2_IRQn, eFlexPWMB_CAP3_IRQn } }
...
#define QSCI_TIDLE_IRQS                          { QSCI0_TIDLE_IRQn, QSCI1_TIDLE_IRQn, QSCI2_TIDLE_IRQn }
...
/** Peripheral QSPI2 base address */
#define QSPI2_BASE                               (0xE0D0u)
/** Peripheral QSPI2 base pointer */
#define QSPI2                                    ((QSPI_Type *)QSPI2_BASE)
/** Array initializer of QSPI peripheral base addresses */
#define QSPI_BASE_ADDRS                          { QSPI0_BASE, QSPI1_BASE, QSPI2_BASE }
/** Array initializer of QSPI peripheral base pointers */
#define QSPI_BASE_PTRS                           { QSPI0, QSPI1, QSPI2 }
/** Interrupt vectors for the QSPI peripheral type */
#define QSPI_RX_IRQS                             { QSPI0_RCV_IRQn, QSPI1_RCV_IRQn, QSPI2_RCV_IRQn }
#define QSPI_TX_IRQS                             { QSPI0_XMIT_IRQn, QSPI1_XMIT_IRQn, QSPI2_XMIT_IRQn }
