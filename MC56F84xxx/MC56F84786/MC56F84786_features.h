...
#ifndef _MC56F84786_FEATURES_H_
#define _MC56F84786_FEATURES_H_
...
/* @brief Has restricted operation mode (bitfield CTRL1[ROM]). */
#define FSL_FEATURE_FLEXCAN_HAS_RESTRICTED_OPERATION_MODE (0)
/* @brief Has retry control (bitfield CTRL2[RETRY]). */
#define FSL_FEATURE_FLEXCAN_FLEXCAN_HAS_RETRY_CONTROL (0)
/* @brief Has fault reaction (bitfield CTRL2[FLT_RXN]). */
#define FSL_FEATURE_FLEXCAN_HAS_FAULT_REACTION (0)
/* @brief Has TX pin override (bitfield MCR[TPOE]). */
...
#define FSL_FEATURE_DAC_HAS_COMPARE_VAL (0)
/* @brief Has DAC CTRL0 register has SYNCEDGE bit field. */
#define FSL_FEATURE_DAC_HAS_SYNC_EDGE (0)
/* @brief Has DAC CTRL0 register has LDOK bit field. */
#define FSL_FEATURE_DAC_HAS_LOAD_OK (0)
/* @brief Has DAC CTRL0 register has ONESHOT bit field. */
#define FSL_FEATURE_DAC_HAS_ONE_SHOT (0)
...
#define FSL_FEATURE_FTFL_PFLASH_BLOCK_SIZE (262144UL)
