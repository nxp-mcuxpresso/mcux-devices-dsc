/******************************************************************************************
    MC56F84789 startup code, default ISR and vector table for use with DSC compiler
...
/******************* Default ISR for QSCI2_TIDLE **********************/
/* Double weak ISR mechanism for QSCI2_TIDLE to facilitate SDK usage. */

/* User could redefine the QSCI2_TIDLE_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSCI2_TIDLE_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSCI2_TIDLE.
Please be noted that ivINT_QSCI2_TIDLE can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSCI2_TIDLE definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSCI2_TIDLE(void);
__attribute__((weak)) void ivINT_QSCI2_TIDLE(void)
{
    QSCI2_TIDLE_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/
...
/******************* Default ISR for QSPI2_XMIT **********************/
/* Double weak ISR mechanism for QSPI2_XMIT to facilitate SDK usage. */

/* User could redefine the QSPI2_XMIT_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSPI2_XMIT_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSPI2_XMIT.
Please be noted that ivINT_QSPI2_XMIT can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSPI2_XMIT definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSPI2_XMIT(void);
__attribute__((weak)) void ivINT_QSPI2_XMIT(void)
{
    QSPI2_XMIT_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for QSPI2_RCV **********************/
/* Double weak ISR mechanism for QSPI2_RCV to facilitate SDK usage. */

/* User could redefine the QSPI2_RCV_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSPI2_RCV_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSPI2_RCV.
Please be noted that ivINT_QSPI2_RCV can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSPI2_RCV definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSPI2_RCV(void);
__attribute__((weak)) void ivINT_QSPI2_RCV(void)
{
    QSPI2_RCV_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/
...
/******************* Default ISR for eFlexPWMB_CAP3 **********************/

/* User could redefine ivINT_eFlexPWMB_CAP3.
Please be noted that ivINT_eFlexPWMB_CAP3 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CAP3 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_eFlexPWMB_CAP3(void);
__attribute__((weak)) void ivINT_eFlexPWMB_CAP3(void)
{
    default_interrupt();
}
...
/******************* Default ISR for eFlexPWMB_CAP2 **********************/

/* User could redefine ivINT_eFlexPWMB_CAP2.
Please be noted that ivINT_eFlexPWMB_CAP2 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CAP2 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_eFlexPWMB_CAP2(void);
__attribute__((weak)) void ivINT_eFlexPWMB_CAP2(void)
{
    default_interrupt();
}
...
/******************* Default ISR for eFlexPWMB_CAP1 **********************/

/* User could redefine ivINT_eFlexPWMB_CAP1.
Please be noted that ivINT_eFlexPWMB_CAP1 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CAP1 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_eFlexPWMB_CAP1(void);
__attribute__((weak)) void ivINT_eFlexPWMB_CAP1(void)
{
    default_interrupt();
}
...
/******************* Default ISR for eFlexPWMB_CAP0 **********************/

/* User could redefine ivINT_eFlexPWMB_CAP0.
Please be noted that ivINT_eFlexPWMB_CAP0 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CAP0 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_eFlexPWMB_CAP0(void);
__attribute__((weak)) void ivINT_eFlexPWMB_CAP0(void)
{
    default_interrupt();
}
...
volatile asm void _vect(void) {
    ...
    JSR >ivINT_QSPI2_XMIT         /* Interrupt no. 55*/
    JSR >ivINT_QSPI2_RCV          /* Interrupt no. 56*/
    ...
    JSR >ivINT_eFlexPWMB_FAULT    /* Interrupt no. 63*/
    JSR >ivINT_eFlexPWMB_RERR     /* Interrupt no. 64*/
    JSR >ivINT_eFlexPWMB_RELOAD3  /* Interrupt no. 65*/
    JSR >ivINT_eFlexPWMB_CAP3     /* Interrupt no. 66*/
    JSR >ivINT_eFlexPWMB_CMP3     /* Interrupt no. 67*/
    JSR >ivINT_eFlexPWMB_RELOAD2  /* Interrupt no. 68*/
    JSR >ivINT_eFlexPWMB_CAP2     /* Interrupt no. 69*/
    JSR >ivINT_eFlexPWMB_CMP2     /* Interrupt no. 70*/
    JSR >ivINT_eFlexPWMB_RELOAD1  /* Interrupt no. 71*/
    JSR >ivINT_eFlexPWMB_CAP1     /* Interrupt no. 72*/
    JSR >ivINT_eFlexPWMB_CMP1     /* Interrupt no. 73*/
    JSR >ivINT_eFlexPWMB_RELOAD0  /* Interrupt no. 74*/
    JSR >ivINT_eFlexPWMB_CAP0     /* Interrupt no. 75*/
