/******************************************************************************************
    MC56F83663 startup code, default ISR and vector table for use with DSC compiler
...
#pragma constarray off
    ...
    /* For MCU silicon revision 1(MARK 1N64Y), OCCS STAT[LOCI] bit is set after ROM exit,
     * clear all interrupt flags at startup to align with RM */
