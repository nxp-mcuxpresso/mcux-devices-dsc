...
#ifndef _MC56F81746_FEATURES_H_
#define _MC56F81746_FEATURES_H_
...
#define FSL_FEATURE_FTFA_PFLASH_BLOCK_SIZE (65536UL)
...
#define FSL_FEATURE_PWM_HAS_CAPTFILT_REGISTER (1)

/* QDC module features */

/* @brief If QDC CTRL2 register has SABIE bit field. */
#define FSL_FEATURE_QDC_CTRL2_HAS_SABIE_BIT_FIELD (1)
/* @brief If QDC CTRL2 register has SABIRQ bit field. */
#define FSL_FEATURE_QDC_CTRL2_HAS_SABIRQ_BIT_FIELD (1)
/* @brief If QDC CTRL2 register has INITPOS bit field. */
#define FSL_FEATURE_QDC_CTRL2_HAS_INITPOS_BIT_FIELD (1)
/* @brief If QDC has CTRL3 register. */
#define FSL_FEATURE_QDC_HAS_CTRL3_REGISTER (1)
/* @brief If QDC has LCOMP1 register. */
#define FSL_FEATURE_QDC_HAS_LCOMP1_REGISTER (1)
/* @brief If QDC has UCOMP1 register. */
#define FSL_FEATURE_QDC_HAS_UCOMP1_REGISTER (1)
/* @brief If QDC has LASTEDGE register. */
#define FSL_FEATURE_QDC_HAS_LASTEDGE_REGISTER (1)
/* @brief If QDC has LASTEDGEH register. */
#define FSL_FEATURE_QDC_HAS_LASTEDGEH_REGISTER (1)
/* @brief If QDC has POSDPER register. */
#define FSL_FEATURE_QDC_HAS_POSDPER_REGISTER (1)
/* @brief If QDC has POSDPERBFR register. */
#define FSL_FEATURE_QDC_HAS_POSDPERBFR_REGISTER (1)
/* @brief If QDC has POSDPERH register. */
#define FSL_FEATURE_QDC_HAS_POSDPERH_REGISTER (1)
/* @brief If QDC CTRL register has CMPIE bit field. */
#define FSL_FEATURE_QDC_CTRL_HAS_CMPIE_BIT_FIELD (0)
...
#define FSL_FEATURE_QDC_CTRL2_HAS_EMIP_BIT_FIELD (1)
/* @brief If QDC FILT register has FILT_PRSC bit field. */
#define FSL_FEATURE_QDC_FILT_HAS_FILT_PRSC_BIT_FIELD (1)
...
#define FSL_FEATURE_SIM_MISC0_HAS_LPI2C1_TRIG_SEL_BIT_FIELD (1)
