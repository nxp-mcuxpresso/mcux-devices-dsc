/******************************************************************************************
    MC56F81746 startup code, default ISR and vector table for use with DSC compiler
...
#include "startup_clock_mode_config.h"
...
#pragma constarray off
    ...
    if (0U == (SIM->RSTAT & SIM_RSTAT_SWR_MASK))
    {
        /*
         * Only check/do mode switch for none software reset.
         * For software reset, it is the responsibility of user(who triggers the software reset)
         * to set proper mode before software reset execution.
         */
#if defined(_SWITCH_TO_FAST_MODE_AT_STARTUP) && (_SWITCH_TO_FAST_MODE_AT_STARTUP > 0U)
        if (0U == (SIM->MISC0 & SIM_MISC0_MODE_STAT_MASK)) /* Check if it is in normal mode */
        {
...
#else
        if (0U != (SIM->MISC0 & SIM_MISC0_MODE_STAT_MASK)) /* Check if it is in fast mode  */
        {
...
#endif /* defined(_SWITCH_TO_FAST_MODE_AT_STARTUP) && (_SWITCH_TO_FAST_MODE_AT_STARTUP > 0U) */
    }
    ...
    OCCS->CTRL &= ~OCCS_CTRL_PRECS_MASK; /* Select internal 8M/2M RC OSC as MSTR_OSC */
    asm(NOP);
    asm(NOP);
    asm(NOP);
    asm(NOP);
...
/******************* Default ISR for DMACH3 **********************/
/* Double weak ISR mechanism for DMACH3 to facilitate SDK usage. */

/* User could redefine the DMACH3_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void DMACH3_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_DMACH3.
Please be noted that ivINT_DMACH3 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_DMACH3 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_DMACH3(void);
__attribute__((weak)) void ivINT_DMACH3(void)
{
    DMACH3_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for DMACH2 **********************/
/* Double weak ISR mechanism for DMACH2 to facilitate SDK usage. */

/* User could redefine the DMACH2_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void DMACH2_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_DMACH2.
Please be noted that ivINT_DMACH2 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_DMACH2 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_DMACH2(void);
__attribute__((weak)) void ivINT_DMACH2(void)
{
    DMACH2_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for DMACH1 **********************/
/* Double weak ISR mechanism for DMACH1 to facilitate SDK usage. */

/* User could redefine the DMACH1_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void DMACH1_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_DMACH1.
Please be noted that ivINT_DMACH1 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_DMACH1 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_DMACH1(void);
__attribute__((weak)) void ivINT_DMACH1(void)
{
    DMACH1_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for DMACH0 **********************/
/* Double weak ISR mechanism for DMACH0 to facilitate SDK usage. */

/* User could redefine the DMACH0_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void DMACH0_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_DMACH0.
Please be noted that ivINT_DMACH0 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_DMACH0 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_DMACH0(void);
__attribute__((weak)) void ivINT_DMACH0(void)
{
    DMACH0_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/
...
/******************* Default ISR for LPI2C1 **********************/
/* Double weak ISR mechanism for LPI2C1 to facilitate SDK usage. */

/* User could redefine the LPI2C1_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void LPI2C1_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_LPI2C1.
Please be noted that ivINT_LPI2C1 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_LPI2C1 definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_LPI2C1(void);
__attribute__((weak)) void ivINT_LPI2C1(void)
{
...
/******************* Default ISR for QDC_INDEX_RO_RU_CMP **********************/

/* User could redefine ivINT_QDC_INDEX_RO_RU_CMP.
Please be noted that ivINT_QDC_INDEX_RO_RU_CMP can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QDC_INDEX_RO_RU_CMP definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QDC_INDEX_RO_RU_CMP(void);
__attribute__((weak)) void ivINT_QDC_INDEX_RO_RU_CMP(void)
{
    default_interrupt();
}
...
/******************* Default ISR for QDC_HOME_WDG_SAB **********************/

/* User could redefine ivINT_QDC_HOME_WDG_SAB.
Please be noted that ivINT_QDC_HOME_WDG_SAB can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QDC_HOME_WDG_SAB definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QDC_HOME_WDG_SAB(void);
__attribute__((weak)) void ivINT_QDC_HOME_WDG_SAB(void)
{
    default_interrupt();
}
