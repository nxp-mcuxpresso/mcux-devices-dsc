 ...
 * @{
 * The current FLASH driver version is 3.3.0.
 *
 * - 3.3.0
 *   - Use unified entry to invoke ROM flash API
 *
 * - 3.2.0
...
#define FSL_FLASH_DRIVER_VERSION (MAKE_VERSION(3U, 3U, 0U))

/*! @brief Flash driver version for ROM*/
#define FSL_FLASH_DRIVER_VERSION_ROM (MAKE_VERSION(3U, 3U, 0U))
