...
typedef struct {
  ...
  __IO uint16_t FILT;                              /**< Input Filter, offset: 0x1 */
  __IO uint16_t WTR;                               /**< Watchdog Timeout, offset: 0x2 */
  __IO uint16_t POSD;                              /**< Position Difference Counter, offset: 0x3 */
  __I  uint16_t POSDH;                             /**< Position Difference Hold, offset: 0x4 */
  __IO uint16_t REV;                               /**< Revolution Counter, offset: 0x5 */
  __I  uint16_t REVH;                              /**< Revolution Hold, offset: 0x6 */
  __IO uint16_t UPOS;                              /**< Upper Position Counter, offset: 0x7 */
  __IO uint16_t LPOS;                              /**< Lower Position Counter, offset: 0x8 */
  __I  uint16_t UPOSH;                             /**< Upper Position Hold, offset: 0x9 */
  __I  uint16_t LPOSH;                             /**< Lower Position Hold, offset: 0xA */
  __IO uint16_t UINIT;                             /**< Upper Initialization, offset: 0xB */
  __IO uint16_t LINIT;                             /**< Lower Initialization, offset: 0xC */
  __I  uint16_t IMR;                               /**< Input Monitor, offset: 0xD */
  __IO uint16_t TST;                               /**< Test, offset: 0xE */
  __IO uint16_t CTRL2;                             /**< Control 2, offset: 0xF */
  __IO uint16_t UMOD;                              /**< Upper Modulus, offset: 0x10 */
  __IO uint16_t LMOD;                              /**< Lower Modulus, offset: 0x11 */
  __IO uint16_t UCOMP;                             /**< Upper Position Compare, offset: 0x12 */
  __IO uint16_t LCOMP;                             /**< Lower Position Compare, offset: 0x13 */
  __I  uint16_t LASTEDGE;                          /**< Last Edge Time, offset: 0x14 */
  __I  uint16_t LASTEDGEH;                         /**< Last Edge Time Hold, offset: 0x15 */
  __I  uint16_t POSDPER;                           /**< Position Difference Period Counter, offset: 0x16 */
  __I  uint16_t POSDPERBFR;                        /**< Position Difference Period Buffer, offset: 0x17 */
  __I  uint16_t POSDPERH;                          /**< Position Difference Period Hold, offset: 0x18 */
  __IO uint16_t CTRL3;                             /**< Control 3, offset: 0x19 */
