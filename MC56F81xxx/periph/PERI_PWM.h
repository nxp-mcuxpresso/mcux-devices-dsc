...
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x30 */
    ...
    __IO uint16_t PHASEDLY;                          /**< Phase Delay Register, array offset: 0x2C, array step: 0x30, valid indices: [1-3] */
    __IO uint16_t CAPTFILTA;                         /**< Capture PWMA Input Filter Register, array offset: 0x2D, array step: 0x30 */
    __IO uint16_t CAPTFILTB;                         /**< Capture PWMB Input Filter Register, array offset: 0x2E, array step: 0x30 */
    __IO uint16_t CAPTFILTX;                         /**< Capture PWMX Input Filter Register, array offset: 0x2F, array step: 0x30 */
  } SM[PWM_SM_COUNT];
