...
typedef enum _vector_type
{
    ...
    kDMACH3_VECTORn                 = 33,          /**< Vector no.33 */
    kDMACH2_VECTORn                 = 34,          /**< Vector no.34 */
    kDMACH1_VECTORn                 = 35,          /**< Vector no.35 */
    kDMACH0_VECTORn                 = 36,          /**< Vector no.36 */
    ...
    kLPI2C1_VECTORn                 = 61,          /**< Vector no.61 */
    ...
    kQDC_HOME_WDG_SAB_VECTORn       = 100,         /**< Vector no.100 */
    ...
    kDSASS_VECTORn                  = 112,         /**< Vector no.112 */
} vector_type_t;
