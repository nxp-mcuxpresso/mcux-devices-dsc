...
#define MCM_CPCR_DMA_CLR_FSM_MASK                (0xFUL)
#define MCM_CPCR_DMA_CLR_FSM_SHIFT               (0UL)
/*! DMA_CLR_FSM - Clear FSM for DMA */
#define MCM_CPCR_DMA_CLR_FSM(x)                  (((uint32_t)(((uint32_t)(x)) << MCM_CPCR_DMA_CLR_FSM_SHIFT)) & MCM_CPCR_DMA_CLR_FSM_MASK)
