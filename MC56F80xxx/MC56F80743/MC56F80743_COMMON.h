...
**
**     Abstract:
**         Peripheral Access Layer for MC56F80743
**
...
/*!
 * @file MC56F80743_COMMON.h
 * @version 0.1
 * @date 2022-01-12
 * @brief Peripheral Access Layer for MC56F80743
 *
 * Peripheral Access Layer for MC56F80743
 */

#if !defined(MC56F80743_COMMON_H_)
#define MC56F80743_COMMON_H_                     /**< Symbol preventing repeated inclusion */

#include "MC56F80743_features.h"
...
typedef enum IRQn {
  ...
  PIT2_ROLLOVR_IRQn            = 87,               /**< PIT2_ROLLOVR interrupt */
  ...
  QDC_HOME_WDG_SAB_DIR_IRQn    = 91,               /**< QDC_HOME_WDG_SAB_DIR interrupt */
...
#define CMP_BASE_ADDRS                           { CMPA_BASE, CMPB_BASE, CMPC_BASE }
/** Array initializer of CMP peripheral base pointers */
#define CMP_BASE_PTRS                            { CMPA, CMPB, CMPC }
...
#define OPAMP_BASE_ADDRS                         { OPAMPA_BASE }
/** Array initializer of OPAMP peripheral base pointers */
#define OPAMP_BASE_PTRS                          { OPAMPA }
...
#define PIT2_BASE                                (0xE120u)
/** Peripheral PIT2 base pointer */
#define PIT2                                     ((PIT_Type *)PIT2_BASE)
/** Array initializer of PIT peripheral base addresses */
#define PIT_BASE_ADDRS                           { PIT0_BASE, PIT1_BASE, PIT2_BASE }
/** Array initializer of PIT peripheral base pointers */
#define PIT_BASE_PTRS                            { PIT0, PIT1, PIT2 }
...
#define QSCI_BASE_ADDRS                          { QSCI0_BASE }
/** Array initializer of QSCI peripheral base pointers */
#define QSCI_BASE_PTRS                           { QSCI0 }
/** Interrupt vectors for the QSCI peripheral type */
#define QSCI_RX_IRQS                             { QSCI0_RCV_IRQn }
#define QSCI_RX_ERR_IRQS                         { QSCI0_RERR_IRQn }
#define QSCI_TX_IRQS                             { QSCI0_TDRE_IRQn }
#define QSCI_TRIDLE_IRQS                         { QSCI0_TRIDLE_IRQn }
