/******************************************************************************************
    MC56F80743 startup code, default ISR and vector table for use with DSC compiler
...
/******************* Default ISR for PIT2_ROLLOVR **********************/

/* User could redefine ivINT_PIT2_ROLLOVR.
Please be noted that ivINT_PIT2_ROLLOVR can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_PIT2_ROLLOVR definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_PIT2_ROLLOVR(void);
__attribute__((weak)) void ivINT_PIT2_ROLLOVR(void)
{
    default_interrupt();
}
...
/******************* Default ISR for QDC_HOME_WDG_SAB_DIR **********************/

/* User could redefine ivINT_QDC_HOME_WDG_SAB_DIR.
Please be noted that ivINT_QDC_HOME_WDG_SAB_DIR can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QDC_HOME_WDG_SAB_DIR definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QDC_HOME_WDG_SAB_DIR(void);
__attribute__((weak)) void ivINT_QDC_HOME_WDG_SAB_DIR(void)
{
    default_interrupt();
}
