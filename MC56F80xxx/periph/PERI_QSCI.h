...
#if !defined(QSCI_H_)
#define QSCI_H_                                  /**< Symbol preventing repeated inclusion */
...
/*! SBRL - Low order bits of SCI Baud Rate divider, a value from 1 to 8191which combine with the
 *    CTRL3[SBRH] field to form a value from 1 to 65535
 */
 ...
 *  0b1..When RSRC = 0: Loop mode with internal TXD fed back to RXD. When RSRC = 1: Single-wire mode with TXD output fed back to RXD.
 */
...
/*! RECEIVE_TRANSMIT_DATA - RECEIVE_TRANSMIT_DATA */
