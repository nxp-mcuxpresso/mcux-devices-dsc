...
#define OPAMP_STAT_OBSERVE_POINT_MASK            (0x4000U)
#define OPAMP_STAT_OBSERVE_POINT_SHIFT           (14U)
/*! OBSERVE_POINT - Reserved. */
#define OPAMP_STAT_OBSERVE_POINT(x)              (((uint16_t)(((uint16_t)(x)) << OPAMP_STAT_OBSERVE_POINT_SHIFT)) & OPAMP_STAT_OBSERVE_POINT_MASK)
