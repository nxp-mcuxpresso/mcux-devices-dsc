...
typedef struct {
  ...
  __IO uint16_t CTRL2;                             /**< Control 2 Register, offset: 0x1 */
  __IO uint16_t FILT;                              /**< Input Filter Register, offset: 0x2 */
  __I  uint16_t LASTEDGE;                          /**< Last Edge Time Register, offset: 0x3 */
  __I  uint16_t POSDPER;                           /**< Position Difference Period Counter Register, offset: 0x4 */
  __I  uint16_t POSDPERBFR;                        /**< Position Difference Period Buffer Register, offset: 0x5 */
  __IO uint16_t UPOS;                              /**< Upper Position Counter Register, offset: 0x6 */
  __IO uint16_t LPOS;                              /**< Lower Position Counter Register, offset: 0x7 */
  __IO uint16_t POSD;                              /**< Position Difference Counter Register, offset: 0x8 */
  __I  uint16_t POSDH;                             /**< Position Difference Hold Register, offset: 0x9 */
  __I  uint16_t UPOSH;                             /**< Upper Position Hold Register, offset: 0xA */
  __I  uint16_t LPOSH;                             /**< Lower Position Hold Register, offset: 0xB */
  __I  uint16_t LASTEDGEH;                         /**< Last Edge Time Hold Register, offset: 0xC */
  __I  uint16_t POSDPERH;                          /**< Position Difference Period Hold Register, offset: 0xD */
  __I  uint16_t REVH;                              /**< Revolution Hold Register, offset: 0xE */
  __IO uint16_t REV;                               /**< Revolution Counter Register, offset: 0xF */
  __IO uint16_t UINIT;                             /**< Upper Initialization Register, offset: 0x10 */
  __IO uint16_t LINIT;                             /**< Lower Initialization Register, offset: 0x11 */
  __IO uint16_t UMOD;                              /**< Upper Modulus Register, offset: 0x12 */
  __IO uint16_t LMOD;                              /**< Lower Modulus Register, offset: 0x13 */
  __IO uint16_t UCOMP0;                            /**< Upper Position Compare Register 0, offset: 0x14 */
  __IO uint16_t LCOMP0;                            /**< Lower Position Compare Register 0, offset: 0x15 */
  union {                                          /* offset: 0x16 */
    __O  uint16_t UCOMP1;                            /**< Upper Position Compare 1, offset: 0x16 */
    __I  uint16_t UPOSH1;                            /**< Upper Position Holder Register 1, offset: 0x16 */
  };
  union {                                          /* offset: 0x17 */
    __O  uint16_t LCOMP1;                            /**< Lower Position Compare 1, offset: 0x17 */
    __I  uint16_t LPOSH1;                            /**< Lower Position Holder Register 1, offset: 0x17 */
  };
  union {                                          /* offset: 0x18 */
    __O  uint16_t UCOMP2;                            /**< Upper Position Compare 2, offset: 0x18 */
    __I  uint16_t UPOSH2;                            /**< Upper Position Holder Register 3, offset: 0x18 */
  };
  union {                                          /* offset: 0x19 */
    __O  uint16_t LCOMP2;                            /**< Lower Position Compare 2, offset: 0x19 */
    __I  uint16_t LPOSH2;                            /**< Lower Position Holder Register 2, offset: 0x19 */
  };
  union {                                          /* offset: 0x1A */
    __O  uint16_t UCOMP3;                            /**< Upper Position Compare 3, offset: 0x1A */
    __I  uint16_t UPOSH3;                            /**< Upper Position Holder Register 3, offset: 0x1A */
  };
  union {                                          /* offset: 0x1B */
    __O  uint16_t LCOMP3;                            /**< Lower Position Compare 3, offset: 0x1B */
    __I  uint16_t LPOSH3;                            /**< Lower Position Holder Register 3, offset: 0x1B */
  };
  __IO uint16_t INTCTRL;                           /**< Interrupt Control Register, offset: 0x1C */
  __IO uint16_t WTR;                               /**< Watchdog Timeout Register, offset: 0x1D */
  __IO uint16_t IMR;                               /**< Input Monitor Register, offset: 0x1E */
  __IO uint16_t TST;                               /**< Test Register, offset: 0x1F */
} EQDC_Type;
...
/*! DMAEN - DMA Enable
 *  0b0..DMA is disabled
 *  0b1..DMA is enabled. DMA request will assert automatically when the values in the outer-set of buffered
 *       compare registers (UCOMP0/LCOMP0;UCOMP1/LCOMP1;UCOMP2/LCOMP2;UCOMP3/LCOMP3), initial registers(UINIT/LINIT) and
 *       modulus registers (UMOD/LMOD) are loaded into the inner-set of buffer and then LDOK is cleared
 *       automatically. After the completion of this DMA transfer, LDOK will be set automatically, it ensures outer-set values
 *       can be loaded into inner-set which in turn triggers DMA again.
 */
