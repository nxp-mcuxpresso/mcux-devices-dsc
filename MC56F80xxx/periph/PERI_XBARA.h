...
typedef enum _xbar_input_signal
{
    ...
    kXBARA_InputPwmaAllTrig         = 15U,         /**< PWMA_ALL_TRIG output assigned to XBARA_IN15 input. */
    ...
    kXBARA_InputEqdcPosmatch0       = 50U,         /**< EQDC_POSMATCH0 output assigned to XBARA_IN50 input. */
    kXBARA_InputEqdcDir             = 51U,         /**< EQDC_DIR output assigned to XBARA_IN51 input. */
    kXBARA_InputEqdcCntUp           = 52U,         /**< EQDC_CNT_UP output assigned to XBARA_IN52 input. */
    kXBARA_InputEqdcCntDn           = 53U,         /**< EQDC_CNT_DN output assigned to XBARA_IN53 input. */
    kXBARA_InputEqdcCompflg0        = 54U,         /**< EQDC_COMPFLG0 output assigned to XBARA_IN54 input. */
    kXBARA_InputEqdcCompflg1        = 55U,         /**< EQDC_COMPFLG1 output assigned to XBARA_IN55 input. */
    kXBARA_InputEqdcCompflg2        = 56U,         /**< EQDC_COMPFLG2 output assigned to XBARA_IN56 input. */
    kXBARA_InputEqdcCompflg3        = 57U,         /**< EQDC_COMPFLG3 output assigned to XBARA_IN57 input. */
    kXBARA_InputSci0RxFull          = 58U,         /**< SCI0_RX_FULL output assigned to XBARA_IN58 input. */
} xbar_input_signal_t;
...
typedef enum _xbar_output_signal
{
    ...
    kXBARA_OutputPit0Preset         = 14U,         /**< XBARA_OUT14 output assigned to PIT0_PRESET */
    kXBARA_OutputPit1Preset         = 15U,         /**< XBARA_OUT15 output assigned to PIT1_PRESET */
    ...
    kXBARA_OutputSci0Rxd            = 19U,         /**< XBARA_OUT19 output assigned to SCI0_RXD */
    ...
    kXBARA_OutputOpampaCfgSelB1C1   = 35U,         /**< XBARA_OUT35 output assigned to OPAMPA_CFG_SEL_B1_C1 */
    kXBARA_OutputOpampbCfgSelB0C0   = 36U,         /**< XBARA_OUT36 output assigned to OPAMPB_CFG_SEL_B0_C0 */
    kXBARA_OutputOpampbCfgSelB1C1   = 37U,         /**< XBARA_OUT37 output assigned to OPAMPB_CFG_SEL_B1_C1 */
    ...
    kXBARA_OutputEqdcPha            = 42U,         /**< XBARA_OUT42 output assigned to EQDC_PHA */
    kXBARA_OutputEqdcPhb            = 43U,         /**< XBARA_OUT43 output assigned to EQDC_PHB */
    kXBARA_OutputEqdcIndex          = 44U,         /**< XBARA_OUT44 output assigned to EQDC_INDEX */
    kXBARA_OutputEqdcHome           = 45U,         /**< XBARA_OUT45 output assigned to EQDC_HOME */
    kXBARA_OutputEqdcTrig           = 46U,         /**< XBARA_OUT46 output assigned to EQDC_TRIG */
    ...
    kXBARA_OutputEqdcCap1           = 65U,         /**< XBARA_OUT65 output assigned to EQDC_CAP1 */
    kXBARA_OutputEqdcCap2           = 66U,         /**< XBARA_OUT66 output assigned to EQDC_CAP2 */
    kXBARA_OutputEqdcCap3           = 67U,         /**< XBARA_OUT67 output assigned to EQDC_CAP3 */
...
typedef struct {
  ...
  __IO uint16_t SEL32;                             /**< Crossbar A Select Register 32, offset: 0x20 */
  __IO uint16_t SEL33;                             /**< Crossbar A Select Register 33, offset: 0x21 */
  __IO uint16_t CTRL0;                             /**< Crossbar A Control Register 0, offset: 0x22 */
  __IO uint16_t CTRL1;                             /**< Crossbar A Control Register 1, offset: 0x23 */
} XBARA_Type;
...
#define XBARA_SEL33_SEL66_MASK                   (0x3FU)
...
#define XBARA_SEL33_SEL67_MASK                   (0x3F00U)
