...
/*! EDBG - Enable Debug
 *  0b0..Assertion of system debug control input ignored.
 *  0b1..When the system debug control is asserted, the DMA stalls the start of a new channel. Executing channels are allowed to complete.
 */
