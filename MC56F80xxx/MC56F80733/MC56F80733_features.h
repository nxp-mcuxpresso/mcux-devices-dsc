...
#ifndef _MC56F80733_FEATURES_H_
#define _MC56F80733_FEATURES_H_
...
#define FSL_FEATURE_SOC_QSCI_COUNT (1)
...
#define FSL_FEATURE_EQDC_CTRL2_HAS_SABIE_BIT_FIELD (0)
/* @brief If QDC CTRL2 register has SABIRQ bit field. */
#define FSL_FEATURE_EQDC_CTRL2_HAS_SABIRQ_BIT_FIELD (0)
/* @brief If QDC CTRL2 register has INITPOS bit field. */
#define FSL_FEATURE_EQDC_CTRL2_HAS_INITPOS_BIT_FIELD (1)
/* @brief If QDC has CTRL3 register. */
#define FSL_FEATURE_EQDC_HAS_CTRL3_REGISTER (0)
/* @brief If QDC has LCOMP1 register. */
#define FSL_FEATURE_EQDC_HAS_LCOMP1_REGISTER (1)
/* @brief If QDC has UCOMP1 register. */
#define FSL_FEATURE_EQDC_HAS_UCOMP1_REGISTER (1)
/* @brief If QDC has LASTEDGE register. */
#define FSL_FEATURE_EQDC_HAS_LASTEDGE_REGISTER (1)
/* @brief If QDC has LASTEDGEH register. */
#define FSL_FEATURE_EQDC_HAS_LASTEDGEH_REGISTER (1)
/* @brief If QDC has POSDPER register. */
#define FSL_FEATURE_EQDC_HAS_POSDPER_REGISTER (1)
/* @brief If QDC has POSDPERBFR register. */
#define FSL_FEATURE_EQDC_HAS_POSDPERBFR_REGISTER (1)
...
#define FSL_FEATURE_FTFA_PFLASH_BLOCK_SIZE (49152UL)
